...
void cabecalho(char titulo[]){
    cout << "PIM II - PROFESSOR EDUARDO SODRÉ - GRUPO 03  \n\n";
    cout << "* "<< titulo<<" *\n\n";
}
...
void menuCadastros(){
    ...
    cout<< "3 - CADASTRO DE MÉDICOS\n";
    cout<< "4 - CADASTRO DE FUNCIONÁRIOS\n";
    cout<< "5 - RECLAMAÇÕES E ELOGIOS\n";
...
void menuPacientes(){
    ...
    cout << "3 - ENDEREÇO DE PACIENTE POR CPF\n";
...
void menuMedicos(){
    cabecalho("MENU DE MÉDICOS");
    cout << "1 - CADASTRAR MÉDICOS\n";
    cout << "2 - LISTA DE MÉDICOS\n";
    cout << "3 - ENDEREÇO DE MÉDICO POR CPF\n";
    cout << "4 - ALTERAR NOME DE MÉDICO\n";
...
void menuFuncionarios(){
    ...
    cout << "2 - LISTA DE FUNCIONÁRIOS\n";
    cout << "3 - ENDEREÇO DE FUNCIONÁRIO POR CPF\n";
    cout << "4 - ALTERAR NOME DE FUNCIONÁRIO\n";
    cout << "5 - EXCLUIR FUNCIONÁRIO\n";
    cout << "6 - VOLTAR AO MENU DE CADASTRO\n";
    cout << "0 - SAIR DO SISTEMA\n";
...
void menuAgendamentos(){
    ...
    cout << "5 - VOLTAR AO MENU DE PRINCIPAL\n";
    cout << "0 - SAIR DO SISTEMA\n";

}

void menuReclamacoeseelogios(){
    cabecalho("MENU DE RECLAMAÇÕES E ELOGIOS");
    cout << "1 - CADASTRAR RECLAMAÇÃO\n";
    cout << "2 - CADASTRAR ELOGIO\n";
    cout << "3 - LISTA DE RECLAMAÇÕES E ELOGIOS\n";
...
void menuRelatorios(){
    ...
    cout << "3 - NOTA MÉDIA RECLAMAÇÕES\n";
    cout << "4 - NOTA MÉDIA ELOGIOS\n";
    cout << "6 - VOLTAR AO MENU PRINCIPAL\n";
    cout << "0 - SAIR DO SISTEMA\n";
...
void relatoriosPacientes(){
    ...
    cout << "DIGITE O CÓDIGO DA UNIDADE: ";
    cin >> codi;
    ...
    if(achou){
        cout << "NENHUMA UNIDADE ENCONTRADA COM O CÓDIGO: "<< codi<< "\n\n";
...
int mediaNotaReclamacao(){
    ...
    cout<<"NOTA MEDIA DAS RECLAMAÇÕES: "<< soma / indiceR<<"\n\n";
...
void relatoriosNotas(){
    ...
    cout<< "A SOMA DAS NOTAS DE ATENDIMENTO É: "<<soma<<"\n\n";
...
void cadastrarUnidades(){
    if(indiceU >= totalCadU){
        cout << "NÃO É POSSIVEL CADASTRAR MAIS UNIDADES, FALE COM O DESENVOLVEDOR\n";
        system("pause");
        return;
    }
    char codigoUnidade[14];
    ...
    cout << "DIGITE O ENDEREÇO DA UNIDADE: ";
...
void cadastrarPacientes(){
    if(indiceP >= totalCadP){
        cout << "NÃO É POSSIVEL CADASTRAR MAIS PACIENTES";
        system("pause");
        return;
    }
    char cpfPaciente[14];
    ...
    for(int i = 0; i < totalCadP; i++){
        if(strcmp(CadP[indiceP].codigoUnidadePaciente, CadU[i].codigoUnidade) ==0){
            ...
            cout << "ENDEREÇO DA UNIDADE: "<<CadU[i].enderecoUnidade<<"\n\n";
            achou = true;
        }
    }
    if(!achou){
        cout << "NENHUMA UNIDADE ENCONTRADA COM O CÓDIGO: "<< codigoUnidadePaciente<< "\n\n";
    }
    }while(!achou);
...
void cadastrarFuncionarios(){
    if(indiceF >= totalCadF){
        cout << "NÃO É POSSIVEL CADASTRAR MAIS FUNCIONÁRIOS";
        system("pause");
        return;
    }
    char cpfFuncionario[14];
    ...
    cout << "CADASTRANDO O FUNCIONÁRIO NO INDICE: "<< indiceF<<"\n";
    ...
    if(!achou){
        cout << "NENHUMA UNIDADE ENCONTRADA COM O CÓDIGO: "<< codigoUnidadeFuncionario<< "\n\n";
    }
    }while(!achou);
    ...
    cout << "DIGITE O CONTATO DE URGÊNCIA DO FUNCIONÁRIO: ";
    cin >> CadF[indiceF].contatoUrgenciaFuncionario;
    cout << "DIGITE O TELEFONE DE URGÊNCIA DO FUNCIONÁRIO: ";
...
void cadastrarMedicos(){
    if(indiceM >= totalCadM){
        cout << "NÃO É POSSIVEL CADASTRAR MAIS MÉDICOS";
        system("pause");
        return;
    }
    char cpfMedico[14];
    char codigoUnidadeMedico[14];
    int vezes = 0;
    cabecalho("CADASTRO DE MÉDICO");
    cout << "CADASTRANDO O MÉDICO NO INDICE: "<< indiceM<<"\n";
    ...
    if(!achou){
        cout << "NENHUMA UNIDADE ENCONTRADA COM O CÓDIGO: "<< codigoUnidadeMedico<< "\n\n";
    }
    }while(!achou);
...
void cadastrarAgendamentos(){
    if(indiceA >= totalCadA){
        cout << "NÃO É POSSIVEL CADASTRAR MAIS UNIDADES";
        system("pause");
        return;
    }
    ...
    if(!achou){
        cout << "NENHUMA UNIDADE ENCONTRADA COM O CÓDIGO: "<< codigoUnidadeAgendamento<< "\n\n";
    }
    }while(!achou);
...
if(!achou){
    ...
    if(!achou){
        cout << "NENHUM FUNCIONÁRIO ENCONTRADO COM O CPF: "<< codigoFuncionarioAgendamento<< "\n\n";
    }
    }while(!achou);


    do { achou = false;
    cout << "CONFIRME O NOME DO FUNCIONÁRIO: ";
    ...
    if(!achou){
        cout << "NENHUM FUNCIONÁRIO ENCONTRADO COM O NOME: "<< nomeFuncionarioAgendamento<< "\n\n";
    }
    }while(!achou);
    ...
    for(int i = 0; i < totalCadM; i++){
        if(strcmp(CadA[indiceA].codigoMedicoAgendamento, CadM[i].cpfMedico) ==0){
            ...
            cout << "\n\n"<<"NOME DO MÉDICO: "<<CadM[i].nomeMedico<<"\n";
            cout << "ESPECIALIDADE DO MÉDICO = "<<CadM[i].especialidadeMedico<<"\n\n";
            achou = true;
        }
    }
    if(!achou){
        cout << "NENHUM MÉDICO ENCONTRADO COM O CPF: "<< codigoMedicoAgendamento<< "\n\n";
    }
    }while(!achou);


    do { achou = false;
    cout << "CONFIRME O NOME DO MÉDICO: ";
    ...
    if(!achou){
        cout << "NENHUM MÉDICO ENCONTRADO COM O NOME: "<< nomeMedicoAgendamento<< "\n\n";
    }
    }while(!achou);
    ...
    for(int i = 0; i < totalCadP; i++){
        if(strcmp(CadA[indiceA].codigoPacienteAgendamento, CadP[i].cpfPaciente) ==0){
            ...
            cout << "ENDEREÇO DO PACIENTE: "<<CadP[i].enderecoPaciente<<"\n\n";
            achou = true;
        }
    }
    if(!achou){
...
void cadastrarReclamacoes(){
    if(indiceR >= totalCadR){
        cout << "NÃO É POSSIVEL CADASTRAR MAIS RECLAMAÇÕES";
        system("pause");
        return;
    }
    char protocoloReclamacoes[14];
    int vezes = 0;
    cabecalho("REGISTRO DE RECLAMAÇÃO");
    cout << "REGISTRANDO A RECLAMAÇÃO NO INDICE: "<< indiceR<<"\n";
    do {
        vezes = 0;
...
void cadastrarElogios(){
     if(indiceE >= totalCadE){
        cout << "NÃO É POSSIVEL REGISTRAR MAIS ELOGIOS";
        system("pause");
        return;
    }
    char protocoloElogios[14];
...
void imprimirReclamacoeseElogios(){
    cabecalho("RECLAMAÇÕES E ELOGIOS");

    cout<<"LISTA DE RECLAMAÇÕES\n\n";
    for(int i = 0; i < indiceR; i++){
        cout<<"PROTOCOLO DE ATENDIMENTO: "<<CadR[i].protocoloReclamacoes<<"\nNOTA DADA AO ATENDIMENTO: "<<CadR[i].notaAtendimentoReclamacao<<"\n"<<"RECLAMAÇÃO DO PACIENTE: "<<CadR[i].reclamacoes<<"\n\n";

    }
    if(indiceR < 1){
        cout << "NÃO EXISTEM RECLAMAÇÕES REGISTRADAS""\n";
    }
    ...
    if(indiceE < 1){
        cout << "NÃO EXISTEM ELOGIOS REGISTRADOS""\n";
    }
...
void imprimirAgendamentos(){
    ...
    for(int i = 0; i < indiceA; i++){
        cout<<"\nAGENDAMENTO NUMERO: "<<i+1<<"\n"<<"DATA: "<<CadA[i].dataAgendamento<<"      -      "<<"HORARIO: "<<CadA[i].horarioAgendamento<<"\nCÓDIGO DA UNIDADE: "<<CadA[i].codigoUnidadeAgendamento<<"      -      "<<"NOME DA CLINICA: "<<CadA[i].nomeUnidadeAgendamento<<"\n"<<"CPF DO PACIENTE: "<<CadA[i].codigoPacienteAgendamento<<"      -      "<<"NOME DO PACIENTE: "<<CadA[i].nomePacienteAgendamento<<"\n"<<"CPF DO MÉDICO: "<<CadA[i].codigoMedicoAgendamento<<"      -      "<<"NOME DO MÉDICO: "<<CadA[i].nomeMedicoAgendamento<<"\nCPF DO FUNCIONÁRIO: "<<CadA[i].codigoFuncionarioAgendamento<<"      -      "<<"NOME DO FUNCIONÁRIO: "<<CadA[i].nomeFuncionarioAgendamento<<"\n"<<"VALOR COBRADO: "<<CadA[i].precoAgendamento<<"\n\n";;

    }
    if(indiceA < 1){
        cout << "NÃO EXISTEM CONSULTAS AGENDADAS""\n";
    }
...
void imprimirPacientes(){
    ...
    if(indiceP < 1){
        cout << "NÃO EXISTEM PACIENTES CADASTRADOS""\n";
    }
...
void imprimirMedicos(){
    ...
    for(int i = 0; i < indiceM; i++){
        cout <<"UNIDADE CADASTRADA: "<<CadM[i].codigoUnidadeMedico<<"\nNOME DO MÉDICO: "<<CadM[i].nomeMedico<<"\n"<<"NUMERO DO CPF: "<< CadM[i].cpfMedico<<"\n"<<"NUMERO DO CRM: "<< CadM[i].crmMedico<<"\n"<<"ESPECIALIDADE DO MÉDICO: "<<CadM[i].especialidadeMedico<<"\n"<<"TELEFONE DO MÉDICO: "<<CadM[i].telefoneMedico<<"\n"<<"ENDEREÇO DO MÉDICO: "<<CadM[i].enderecoMedico<<"\n\n\n";

    }
    if(indiceM < 1){
        cout << "NÃO EXISTEM MÉDICOS CADASTRADOS""\n";
    }
...
void exibeEnderecoUnidade(){
    char codi[14];
    bool achou = false;
    cabecalho("ENDEREÇO DE UNIDADE POR CÓDIGO");
    cout << "DIGITE O CÓDIGO: ";
    cin >> codi;
    for(int i = 0; i < totalCadU; i++){
        if(strcmp (codi, CadU[i].codigoUnidade) == 0){
            cout << "\n\n"<<"NOME DA UNIDADE: "<<CadU[i].nomeUnidade<<"\n";
            cout << "\n""ENDEREÇO DA UNIDADE: "<<CadU[i].enderecoUnidade<<" - "<<CadU[i].cidadeUnidade<<"\n";
            cout << "\n""CEP DA UNIDADE: "<<CadU[i].cepUnidade<<"\n";
            achou = true;
...
void exibeEnderecoPaciente(){
    char codi[14];
    bool achou = false;
    cabecalho("ENDEREÇO DE PACIENTE POR CPF");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadP; i++){
        if(strcmp (codi, CadP[i].cpfPaciente) == 0){
            cout << "\n\n"<<"NOME DO PACIENTE: "<<CadP[i].nomePaciente<<"\n";
            cout << "\n""ENDEREÇO DO PACIENTE = "<<CadP[i].enderecoPaciente<<"\n";
            achou = true;
...
void exibeEnderecoMedico(){
    char codi[14];
    bool achou = false;
    cabecalho("ENDEREÇO DE MÉDICO POR CPF");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadM; i++){
    ...
    if(!achou){
        cout << "NENHUM MÉDICO ENCONTRADO COM O CPF: "<< codi<< "\n";
    }
    system("pause");
}
...
void exibeEnderecoFuncionario(){
    char codi[14];
    bool achou = false;
    cabecalho("ENDEREÇO DE FUNCIONÁRIO POR CPF");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadF; i++){
        if(strcmp (codi, CadF[i].cpfFuncionario) == 0){
            cout << "\n\n"<<"NOME DO FUNCIONÁRIO: "<<CadF[i].nomeFuncionario<<"\n";
            cout << "\n""ENDEREÇO DO FUNCIONÁRIO: "<<CadF[i].enderecoFuncionario<<"\n";
            achou = true;

        }
    }
    if(!achou){
        cout << "NENHUM FUNCIONÁRIO ENCONTRADO COM O CPF: "<< codi<< "\n";
...
void alterarUnidade(){
    char codi[14];
    bool achou = false;
    cabecalho("ALTERAÇÃO DE NOME - UNIDADE");
    cout << "DIGITE O CÓDIGO: ";
    cin >> codi;
    for(int i = 0; i < totalCadU; i++){
        if(strcmp(codi, CadU[i].codigoUnidade) ==0){
            cout << "\n\n"<<"CÓDIGO: "<<CadU[i].codigoUnidade<<"\n";
            cout << "NOME: "<<CadU[i].nomeUnidade<<"\n";
            cout << "TELEFONE: "<<CadU[i].telefoneUnidade<<"\n";
            cout << "ENDEREÇO: "<<CadU[i].enderecoUnidade<<"\n";
...
void alterarDataAgendamento(){
    char codi[14];
    bool achou = false;
    cabecalho("ALTERAÇÃO DE DATA DO AGENDAMENTO");
    cout << "DIGITE O CPF DO PACIENTE: ";
    cin >> codi;
    for(int i = 0; i < totalCadA; i++){
        if(strcmp(codi, CadA[i].codigoPacienteAgendamento) ==0){
            ...
            cout << "CPF DO MÉDICO: "<<CadA[i].codigoMedicoAgendamento<<"\n";
...
void alterarPaciente(){
    char codi[14];
    bool achou = false;
    cabecalho("ALTERAÇÃO DE NOME - PACIENTE");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadP; i++){
        if(strcmp(codi, CadP[i].cpfPaciente) ==0){
            ...
            cout << "ENDEREÇO: "<<CadP[i].enderecoPaciente<<"\n";
            cout << "CONTATO PARA URGENCIA: "<<CadP[i].contatoUrgencia<<"\n";
...
void alterarMedico(){
    char codi[14];
    bool achou = false;
    cabecalho("ALTERAÇÃO DE NOME - MÉDICO");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadM; i++){
        if(strcmp(codi, CadM[i].cpfMedico) ==0){
            ...
            cout << "ENDEREÇO: "<<CadM[i].enderecoMedico<<"\n\n";
            cout << "DIGITE ABAIXO O NOVO NOME\n\n";
            cout << "NOME: ";
...
void alterarFuncionario(){
    char codi[14];
    bool achou = false;
    cabecalho("ALTERAÇÃO DE NOME - FUNCIONÁRIO");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadF; i++){
        if(strcmp(codi, CadF[i].cpfFuncionario) ==0){
            ...
            cout << "ENDEREÇO: "<<CadF[i].enderecoFuncionario<<"\n";
            cout << "CONTATO PARA URGENCIA: "<<CadF[i].contatoUrgenciaFuncionario<<"\n";
...
void excluirUnidade(){
    ...
    if(!achou){
        cout << "\n""NENHUMA UNIDADE ENCONTRADA COM O CÓDIGO: "<< codi<< "\n";
    }
    system("pause");
}
...
void excluirAgendamento(){
    ...
    bool achou = false;
    char confirma;
    cabecalho("EXCLUSÃO DE AGENDAMENTO");
    cout << "DIGITE O CPF DO PACIENTE: ";
    cin >> codi;
    for(int i = 0; i < totalCadA; i++){
        if(strcmp(codi, CadA[i].codigoPacienteAgendamento) ==0){
...
void excluirPaciente(){
    ...
    bool achou = false;
    char confirma;
    cabecalho("EXCLUSÃO DE PACIENTE");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadP; i++){
        if(strcmp(codi, CadP[i].cpfPaciente) ==0){
...
void excluirMedico(){
    ...
    for(int i = 0; i < totalCadM; i++){
        if(strcmp(codi, CadM[i].cpfMedico)==0){
            ...
            cout << "ESPECIALIDADE: "<<CadM[i].especialidadeMedico<<"\n";
            cout << "TELEFONE: "<<CadM[i].telefoneMedico<<"\n";
            cout << "ENDEREÇO DO MÉDICO: "<<CadM[i].enderecoMedico<<"\n";
            cout << "DESEJA REALMENTE EXCLUIR? (s/n)\n";
            cin >> confirma;
            switch(confirma){
                case 's':
    ...
    if(!achou){
        cout << "\n""NENHUM MÉDICO ENCONTRADO COM O CPF: "<< codi<< "\n";
    }
    system("pause");
}
...
void excluirFuncionario(){
    ...
    bool achou = false;
    char confirma;
    cabecalho("EXCLUSÃO DE FUNCIONÁRIO");
    cout << "DIGITE O CPF: ";
    cin >> codi;
    for(int i = 0; i < totalCadF; i++){
        if(strcmp(codi, CadF[i].cpfFuncionario) ==0){
            ...
            cout << "NOME: "<<CadF[i].nomeFuncionario<<"\n";
            cout << "TELEFONE: "<<CadF[i].telefoneFuncionario<<"\n";
            cout << "ENDEREÇO DO FUNCIONÁRIO: "<<CadF[i].enderecoFuncionario<<"\n";
            cout << "CONTATO PARA URGENCIA: "<<CadF[i].contatoUrgenciaFuncionario<<"\n";
            cout << "TELEFONE PARA URGENCIA: "<<CadF[i].telefoneUrgenciaFuncionario<<"\n\n";
            cout << "DESEJA REALMENTE EXCLUIR? (s/n)\n";
            cin >> confirma;
    ...
    if(!achou){
        cout << "\n""NENHUM FUNCIONÁRIO ENCONTRADO COM O CPF: "<< codi<< "\n";
    }
    system("pause");
}
...
void abrirArquivoReclamacoes(char numeroProtocolo[], char tipo[]){
    ...
    if(pont_arqR == NULL){
        cout << "ERRO AO ABRIR O ARQUIVO DE RECLAMAÇÕES\n";
    }
}
...
void abrirArquivoMedico(char nomeMedico[], char tipo[]){
    ...
    if(pont_arqM == NULL){
        cout << "ERRO AO ABRIR O ARQUIVO DOS MÉDICOS\n";
    }
}
...
void abrirArquivoFuncionario(char nomeFuncionario[], char tipo[]){
    ...
    if(pont_arqF == NULL){
        cout << "ERRO AO ABRIR O ARQUIVO DOS FUNCIONÁRIOS\n";
    }
}
...
void gravarReclamacoes(){
    ...
    fclose(pont_arqR);
    cout << "REGISTRO DE RECLAMAÇÕES GRAVADO COM SUCESSO\n";
...
void gravarCadastroMedico(){
    ...
    fclose(pont_arqM);
    cout << "CADASTRO DE MÉDICOS GRAVADO COM SUCESSO\n";

}


void gravarCadastroFuncionario(){
    abrirArquivoFuncionario("FUNCIONÁRIOS.txt", "w");
    for(int i = 0; i < indiceF; i++){
       fwrite(&CadF[i], sizeof(struct cadFuncionarios), 1, pont_arqF);
    }
    fclose(pont_arqF);
    cout << "CADASTRO DE FUNCIONÁRIOS GRAVADO COM SUCESSO\n";
...
void lerCadastroReclamacoes(){
    ...
    fclose(pont_arqR);
    indiceR = contador;
    cout << "REGISTRO DE RECLAMAÇÕES RECUPERADO COM SUCESSO\n";
...
void lerCadastroMedico(){
    ...
    fclose(pont_arqM);
    indiceM = contador;
    cout << "CADASTRO DE MÉDICOS RECUPERADO COM SUCESSO\n";

}

void lerCadastroFuncionario(){
    abrirArquivoFuncionario("FUNCIONÁRIOS.txt", "r");
    int contador = 0;
    do{
    ...
    fclose(pont_arqF);
    indiceF = contador;
    cout << "CADASTRO DE FUNCIONÁRIOS RECUPERADO COM SUCESSO\n";
...
bool login(){
    ...
    while(!deuCerto){
        ...
        cin >> senha;
        if(strcmp(usuario, "ricardoamaro") == 0){
...
void sobre(){
    ...
    cout << "PROGRAMA DESENVOLVIDO POR: \n\n"<<"CAIO LUCAS CABELO ALBINO - RA: F236021""\n"<<"GREGORY DE OLIVEIRA MACHADO - RA: N594420""\n"<<"PEDRO HENRIQUE DE PAIVA - RA: N627514""\n"<<"RICARDO AMARO DE OLIVEIRA - RA: G179420""\n\n";
    system("pause");
}
